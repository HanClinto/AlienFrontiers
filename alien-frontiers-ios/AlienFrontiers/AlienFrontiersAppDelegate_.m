...
#import "AlienFrontiersAppDelegate.h"
#import "GameConfig.h"
...
@implementation AlienFrontiersAppDelegate
...
- (void)applicationWillTerminate:(UIApplication *)application {
    ...
    if ([GameState sharedGameState])
    {
        [GameState saveGameStateToPrefs:[[GameState sharedGameState] serialize]];
    }
